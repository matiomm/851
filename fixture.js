(function e(t, n, r) {
    ...
    13: [function(t, e, n) {
        ...
        e.exports = {
            ...
            formatPercent: function(t, e) {
                return void 0 === e && (e = ""), 0 == t ? "&nbsp;" : .01 >= t ? "0%" : t > .99 && 1 >= t ? "100%" : 1 == t ? e + "&nbsp;" : Math.round(100 * t) + "%"
            },
    ...
    20: [function(t, e, n) {
        ...
        s(r, t("events").EventEmitter), e.exports = r, r.prototype.initialize = function() {
			...
			if (typeof(this.containerSVG) != "undefined") {
	            this.$el.width() >= 364 && (this.containerSVG.remove(), this.initialize(), "complete" === this.groupStatus && this._showCompletedGroup())
			}
			else{
				this.$el.width() >= 364 && (this.initialize(), "complete" === this.groupStatus && this._showCompletedGroup())
			}
