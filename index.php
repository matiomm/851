  ...
  window.onload = function () {
    ...
    function visGrupos(data) {
      ...
      thead = tabla.append("thead");
        ...
        thead.append("th").attr("onClick","sortTable(1)").style("cursor","pointer").style("width","17%").text("1");
        thead.append("th").attr("onClick","sortTable(2)").style("cursor","pointer").style("width","17%").text("2");
        thead.append("th").attr("onClick","sortTable(3)").style("cursor","pointer").style("width","17%").text("3");
        thead.append("th").attr("onClick","sortTable(4)").style("cursor","pointer").style("width","17%").text("Probabilidad de Descenso");
      ...
      for (i in data){
          ...
          tr.append("td").style("border-right","2px solid").style("font-weight","bold").text(data[i].Equipo);
          tr.append("td").style("text-align","center").style("background-color", colorScale(data[i][1])).text(d3.format(",.3~p")(data[i][1]));
          tr.append("td").style("text-align","center").style("background-color", colorScale(data[i][2])).text(d3.format(",.3~p")(data[i][2]));
          tr.append("td").style("text-align","center").style("background-color", colorScale(data[i][3])).text(d3.format(",.3~p")(data[i][3]));
          tr.append("td").style("text-align","center").style("background-color", colorScale(data[i]["Prob Desc"])).text(d3.format(",.3~p")(data[i]["Prob Desc"]));
      }
      sortTable(2);
